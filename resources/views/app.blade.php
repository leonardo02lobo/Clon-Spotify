					...
					<div class="container-card-concentracion">
						<div class="card-concentracion">
							<div class="card">
								<div class="card-img">
									<img
										src="{{asset('Multimedia/Kidd-Keo-Back-To-Rockport.png')}}"
										alt="Back To The Rockport"
									/>
								</div>
								<h2>Back To The Rockport</h2>
								<p>Kidd Keo</p>
							</div>
						</div>
						<div class="card-concentracion">
							<div class="card">
								<div class="card-img">
									<img
										src="{{asset('Multimedia/Muerte-Canserbero.png')}}"
										alt="Muerte"
									/>
								</div>
								<h2>Muerte</h2>
						...
						<div class="card-concentracion">
							<div class="card">
								<div class="card-img">
									<img
										src="{{asset('Multimedia/Sol-maria.png')}}"
										alt="Sol Maria"
									/>
								</div>
								<h2>Sol Maria</h2>
						...
						<div class="card-concentracion">
							<div class="card">
								<div class="card-img">
									<img
										src="{{asset('Multimedia/Tu-Duo-Favorito.png')}}"
										alt="Tu duo Favorito"
									/>
								</div>
								<h2>Tu Duo Favorito</h2>
								<p>YSY A and Bhavi</p>
							</div>
						</div>
						<div class="card-concentracion">
							<div class="card">
								<div class="card-img">
									<img
										src="{{asset('Multimedia/vida-Canserbero.png')}}"
										alt="Vida"
									/>
								</div>
								<h2>Vida</h2>
				...
				<div class="container-name-spotify-playlists">
					...
					<div class="container-card-spotify-playlists">
						<div class="card-spotify-playlists">
							<div class="card">
								<div class="card-img">
									<img src="{{asset('Multimedia/Muerte-Canserbero.png')}}" alt="">
								</div>
								<h2>Vida</h2>
								<p>Canserbero</p>
							</div>
